...
module Shared
  class EmptyStateComponent < ViewComponent::Base
    ...
    # Icon library with 8 Heroicons (outline style, 24px)
    ICONS = {
    ...
    def render_icon
      icon_svg = ICONS[@icon] || ICONS[:inbox]

      content_tag(:div, class: "mx-auto h-16 w-16 text-gray-400") do
        content_tag(:svg, raw(icon_svg), class: "h-full w-full", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", aria: { hidden: "true" })
      end
    end
  end
end
