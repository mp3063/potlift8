...
export default class extends Controller {
  ...
  updateEmptyMessages() {
    ...
    if (selectedLabels.length === 0) {
      const emptyMessage = `<p class="text-sm text-gray-500 py-1" data-product-label-manager-target="emptyMessage" role="listitem">No labels selected. Use Add to attach one.</p>`
